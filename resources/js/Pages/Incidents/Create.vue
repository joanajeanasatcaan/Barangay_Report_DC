  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <Link
          href="/incidents"
          class="flex items-center px-4 py-2 font-medium text-gray-700 transition duration-150 ease-in-out bg-gray-200 rounded-md shadow hover:bg-gray-300"
        >
          ...
          <div class="p-6">
            <form @submit.prevent="submit" class="space-y-6">
              <div>
                ...
                <div class="mt-1">
                  <input
                    ...
                    class="block w-full p-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              ...
              <div class="flex justify-end">
                ...
                <button
                  type="submit"
                  class="flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
